...
// ✅ Simple flag: change to true later if you want to reopen registration
...
export default function RegistrationForm() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 text-white flex items-center justify-center p-6 py-16">
        {/* 🔒 If registration is closed, show message instead of form */}
        {!REGISTRATION_OPEN ? (
          <div className="w-full max-w-xl bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/10 shadow-2xl text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-red-300 via-orange-300 to-yellow-300">
              Frolic 2025 Registration Closed
            </h2>
            ...
            <p className="text-sm md:text-base text-white/80">
              Agar aapko <span className="font-semibold">Frolic 2025</span> ke
              kisi bhi game / event ke liye registration karwana hai, to{" "}
              <span className="font-semibold text-sky-300">
                apne game ke coordinator se contact karein.
              </span>
            </p>
            <p className="text-xs text-white/50 mt-4">
              For any queries, kindly reach out to your respective game
              coordinator.
            </p>
          </div>
        ) : (
          // ✅ Old form (will only show when REGISTRATION_OPEN = true)
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="w-full max-w-2xl bg-gradient-to-br from-white/3 to-white/2 backdrop-blur-md p-8 rounded-3xl border border-white/6 shadow-2xl"
            noValidate
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                >
                  ...
                  <option value="third" className="text-gray-700">
                    Third
                  </option>
                  <option value="fourth" className="text-gray-700">
                    Fourth
                  </option>
                </select>
                {errors.year && (
            ...
            <p className="text-xs text-white/60 mt-3 text-center">
              Note: status will be set by coordinator (defaults to{" "}
              <code>pending</code>).
            </p>
          </form>
        )}
